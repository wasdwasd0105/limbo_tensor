...
public enum MachineProperty {
    ...
    ARCH, MACHINETYPE, CPU, CPUNUM, MEMORY, ENABLE_UEFI, ENABLE_KVM,
    ...
    EXTRA_PARAMS, USB1_PATH, USB2_PATH, USB3_PATH, USB4_PATH, USB1_ENABLE, USB2_ENABLE, USB3_ENABLE, USB4_ENABLE, OTHER
}
